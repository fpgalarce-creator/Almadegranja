...
export const CartDrawer = ({ isOpen, onClose, user, onCartChange }: CartDrawerProps) => {
  ...
  return (
    <div className="fixed inset-0 z-40 pointer-events-none">
      ...
      <div className="pointer-events-auto fixed top-24 right-4 w-[calc(100%-1.5rem)] sm:w-[420px] max-w-[520px]">
        <div className="rounded-3xl bg-white shadow-2xl border border-kraft/70 overflow-hidden transform transition duration-300 origin-top right-0 cart-flyout">
          <div className="flex items-center justify-between p-6 border-b border-kraft/60 bg-body/70 backdrop-blur">
            <div>
          ...
          <div className="p-6 border-t border-kraft/60 space-y-3 bg-white">
